...
/**
 * remove node from its list, won't free data
 * @param node
 */
...
/**
 * concat the src list to the dest list, note: the src list will be deallocated
 * @param dest
 * @param src
 */
void concatList(List dst, List src);

/**
 * note: exist will compare addresses, make sure data are of the same class
 * @param list
 * @param data
 * @return
 */
bool existsInList(List list, void*data);
